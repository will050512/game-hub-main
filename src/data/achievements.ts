...
export const achievementDefs: AchievementDef[] = [
  ...
  { id: 'snake_50', name: '巨蛇傳說', description: '貪吃蛇吃掉50顆蘋果', icon: 'heart', category: 'mastery', rarity: 'uncommon', condition: { type: 'kills', gameId: 'snake', threshold: 50 }, reward: { coins: 200 } },
  ...
  { id: 'all_games', name: '全能玩家', description: '玩過所有遊戲', icon: 'sparkle', category: 'special', rarity: 'epic', condition: { type: 'uniqueGamesPlayed', threshold: 12 }, reward: { coins: 1000, badge: 'all_rounder' } },
